...
<html lang="en">
  ...
  ?>
          ...
          <h3 class="action" ><span style="font-family: 'Roboto Slab', serif">CHOOSE AN ACTION</h3></span>
            <div class="column activity text-center">
                  ...
                  <div class="col-md act">
                    ...
                    <br>
                    <br>
                    <a href="transactionhistory.php"><button><b>TRANSFER HISTORY</b></button></a>
                  </div>
                  ...
                  <div class="col-md act">
                    ...
                    <br>
                    <br>
                    <a href="transfermoney.php"><button><b>VIEW CUSTOMER TO TRANSFER</b></button></a>
                  </div>
      ...
      <footer class="text-center mt-5 py-2">
        <p>@ PROJECT BY <b>YASH ARORA</b> <br>FOR THE SPARKS FOUNDATION </p>
      </footer>
